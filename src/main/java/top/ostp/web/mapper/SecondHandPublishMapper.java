...
public interface SecondHandPublishMapper {
    @Insert("insert into second_hand_publish(person, book, price, exchange, status) values (#{person.id},#{book.isbn},#{price},#{exchange},#{status})")
    ...
    int deleteByBookISBN(@Param("book") Book book);
//
